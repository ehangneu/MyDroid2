...
public class Main2 extends Activity implements View.OnClickListener{
    ...
    private final String TAG = "Main2222";
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.button1:
                intent = new Intent(Main2.this, BaseService.class);
            ...
            case R.id.button2:
                ...
                break;
            case R.id.button3:
                mTxt.setText(new SimpleDateFormat("HH:mm:ss").format(System.currentTimeMillis()));
                break;
        }
    }
}
